<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-form.field.partials.text id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-form.field.partials.text id="password" class="block mt-1 w-full"
                            type="password"
                            name="password"

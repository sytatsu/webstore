            ...
            <div class="relative z-20 px-6 pt-12 pb-12 md:px-12 md:py-20 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 min-h-[400px] md:min-h-[500px]">
                <div class="flex flex-col gap-8 w-full md:max-w-none">
                    ...
                    <div class="flex flex-wrap justify-start gap-4">
                        ...
                        <a href="{{ route('sytatsu.webstore.collection', 'fdm-printing') }}" class="px-6 py-2.5 md:px-8 md:py-3 bg-white/10 hover:bg-white/20 text-white font-bold rounded-lg transition-colors backdrop-blur-sm border border-white/20 text-sm md:text-base">
                            {{ __('FDM Printing') }}
                        </a>

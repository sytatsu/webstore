...
<div x-data="{ openBanner: false, openPolicy: false }" id="cookie-init"
     x-init="() => localStorage.getItem('cookies') ? null : setTimeout(() => openBanner = true, 500)"
    ...
    <div  x-show="openBanner"
          ...
          class="p-4 border border-gray-200 rounded-xl shadow-md dark:shadow-primary bg-white/80 dark:bg-gray-700/80 dark:border-neutral-800 backdrop-blur-sm">
    ...
    <div  x-show="openPolicy"
        ...
        <div class="ease-out transition-all sm:max-w-lg sm:w-full sm:mx-auto">
            <div class="relative flex flex-col m-auto shadow-lg dark:shadow-gray-800 bg-white dark:bg-gray-800 dark:border-neutral-900">
                ...
                <div class="flex flex-col p-4 sm:px-14 sm:py-10 gap-10 text-center overflow-y-auto">
                    ...
                    <div class="flex flex-col text-gray-800 dark:text-neutral-200 gap-4">
                        ...
                        <div class="flex flex-col">
                            <i><b>{{ __('Analytical cookies') }}</b></i>
                            <span>{{ __('used for collecting anonymous information about the use of your website. The information is used only to improve your website\'s quality and functionality') }}</span>
                        </div>
                ...
                <div class="flex items-center">
                    <button @click="openPolicy = false, openBanner = false, localStorage.setItem('cookies', true)" type="button" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold border border-transparent bg-primary text-white hover:bg-primary-dark focus:outline-hidden hover:bg-primary-dark disabled:opacity-50 disabled:pointer-events-none cursor-pointer transition">
                        {{ __('Got it') }}
                    </button>
                </div>
            </div>

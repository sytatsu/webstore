<div class="flex flex-col gap-4">
    ...
    <x-section-header>
        ...
        <x-slot name="actions">
            <x-secondary-button-link class="my-auto" href="{{ route('catalog.products.variants.create', $product) }}">
            ...
            <x-slot name="content">
                @foreach($productVariants as $productVariant)
                    <x-table.row>
                        ...
                        <x-slot name="actions">
                            <x-actions.button href="{{ route('catalog.products.variants.show', ['product' => $product, 'productVariant' => $productVariant]) }}">
                                <i class="fa fa-eye pr-1"></i><span>{{ __('Show variant') }}</span>
                            </x-actions.button>

                            <x-actions.button href="{{ route('catalog.products.variants.edit', ['product' => $product, 'productVariant' => $productVariant]) }}">

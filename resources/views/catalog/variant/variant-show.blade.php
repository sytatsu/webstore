<x-layouts.catalog.variant-layout>
        ...
        <x-section-header>
            ...
            <x-slot name="actions">
                <div class="text-end p-4">
                    <x-secondary-button-link :href="route('catalog.variants.edit', ['variant' => $variant, 'action' => \App\Enums\Actions\SaveAndAction::TO_MODEL->toString()])">
    ...
    @include('catalog.variant.partials.variant-delete-modal', $variant)
</x-layouts.catalog.variant-layout>

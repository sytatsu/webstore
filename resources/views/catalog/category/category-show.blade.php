<x-layouts.catalog.category-layout>
            ...
            <x-section-header>
                ...
                <x-slot name="actions">
                    <div class="text-end p-4">
                        <x-secondary-button-link :href="route('catalog.categories.edit', ['category' => $category, 'action' => \App\Enums\Actions\SaveAndAction::TO_MODEL->toString()])">
    ...
    @include('catalog.category.partials.category-delete-modal', $category)
</x-layouts.catalog.category-layout>

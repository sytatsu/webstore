                    ...
                    <x-table.row :checkbox="true">
                        <td>
                            <a class="w-full h-full avenir-bold underline text-secondary hover:text-secondary-dark"
                               href="{{ route('catalog.brands.show', $brand) }}">{{ $brand->name }}</a>
                        </td>
                        <td>
                        ...
                        <x-slot name="actions">
                            <x-table.partials.action :href="route('catalog.brands.show', $brand)">
                                <i class="fa fa-eye w-6"></i>Show
                            </x-table.partials.action>

                            <x-table.partials.action :href="route('catalog.brands.edit', ['brand' => $brand, 'action' => \App\Enums\Actions\SaveAndAction::TO_OVERVIEW->name])">

        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-text class="font-medium text-xs text-gray-500">
                            {{ Auth::user()->email }}
                        </x-dropdown-text>
                        ...
                        @if (Auth::user()->isAdmin())
                            ...
                            <x-dropdown-link :href="route('admin.management.profile.index')">
                                <i class="fa fa-users"></i> {{ __('Profile Management') }}
                            </x-dropdown-link>
                        @endif
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                @if (Auth::user()->isAdmin())
                    ...
                    <x-responsive-nav-link :href="route('admin.management.profile.index')" :active="request()->routeIs('admin.management.profile*')">
                        <i class="fa fa-users"></i> {{ __('Profile Management') }}
                    </x-responsive-nav-link>
                @endif

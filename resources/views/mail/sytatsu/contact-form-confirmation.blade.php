    ...
    <tr>
        ...
        <td bgcolor="#ffffff" style="border: 1px solid #eeeeee; background-color: #ffffff; border-radius:5px; display:block!important; max-width:600px!important; margin:0 auto!important; clear:both!important;"><div style="padding:20px; max-width:600px; margin:0 auto; display:block;">
                <table style="width: 100%;">
                    <tr>
                        <td><p style="text-align: center; display: block;  padding-bottom:20px;  margin-bottom:20px; border-bottom:1px solid #dddddd;"><img style="padding: 0 20px" width="520px" src="{{ $message->embed(public_path('images/brands/no_background_text_only.webp')) }}"/></p>
                            ...
                            <a href="https://sytatsu.nl/" style="text-align: center; display: block; padding-top:20px; font-weight: bold; margin-top:30px; color: #7ad1f1; border-top:1px solid #dddddd;">Sytatsu.nl</a></td>
                    </tr>
                </table>
            </div></td>
        <td></td>
